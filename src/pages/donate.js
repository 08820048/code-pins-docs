...
export default function Donate() {
  ...
  return (
    <Layout
      title="捐赠支持"
      description="通过捐赠支持 CodePins 插件的开发和优化">
      <div className={styles.container}>
        <div className={styles.donateContainer}>
          <h1 className={styles.title}>捐赠支持</h1>
          ...
          <div className={styles.donateSection}>
            ...
            <p className={styles.donateText}>
              CodePins 是一个完全免费且开源的 IntelliJ 平台插件，旨在帮助开发者更高效地组织和导航代码。
              我们致力于提供最佳的用户体验和功能，不断优化和改进插件的性能和可用性。
            </p>
            <p className={styles.donateText}>
              作为一个开源项目，我们不依赖商业利润，而是依靠社区的支持和贡献。
              如果您发现 CodePins 对您的工作有所帮助，并希望支持我们的持续开发和维护，
              您可以考虑通过以下方式进行捐赠。
            </p>
          </div>
          ...
          <div className={styles.donateSection}>
            ...
            <p className={styles.donateText}>
              通过 GitHub Sponsors 平台支持我们，这是一种安全透明的方式：
            </p>
            <a 
          ...
          <div className={styles.thankYouNote}>
            <h3>感谢您的支持！</h3>
            <p>
              每一笔捐赠，无论金额大小，对我们都意义重大。<br />
              如果您有任何问题或建议，请随时通过 GitHub Issues 或我们的反馈页面与我们联系。
            </p>
